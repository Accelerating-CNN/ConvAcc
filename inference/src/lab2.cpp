...
int main(int argc, char * argv[])
{
	...
	if(select == 0){
		...
		bench_net("data/smallnet_weights.dat",smallNet,1);
		bench_net("data/mediumnet_weights.dat",mediumNet,1);
		bench_net("data/largenet_weights.dat",largeNet,1);
		bench_net("data/giantnet_weights.dat",giantNet,1);
	}
	return 0;
}
